                    ...
                    <div class="grid grid-cols-2 sm:grid-cols-4 lg:grid-cols-2 gap-5">
                        <div class="relative">
                            ...
                            <label
                                ...
                                for="master-card">
                                <img src="{{ asset('/assets/fronsite/images/master-card.png') }}"
                        ...
                        <div class="relative">
                            ...
                            <label
                                class="flex flex-col justify-center items-center bg-white border-[#EDEDED] cursor-pointer focus:outline-none hover:bg-gray-50 peer-checked:ring-[#0D63F3] peer-checked:ring-2 peer-checked:border-transparent rounded-3xl border-2 p-7"
                                for="visa">
                                <img src="{{ asset('/assets/fronsite/images/visa.png') }}"
                                    class="max-h-[50px] inline-block" alt="Master card" />
                            </label>
                        </div>
                        ...
                        <div class="relative">
                            ...
                            <label
                                class="flex flex-col justify-center items-center bg-white border-[#EDEDED] cursor-pointer focus:outline-none hover:bg-gray-50 peer-checked:ring-[#0D63F3] peer-checked:ring-2 peer-checked:border-transparent rounded-3xl border-2 p-7"
                                for="cirrus">
                                <img src="{{ asset('/assets/fronsite/images/cirrus.png') }}"
                                    class="max-h-[50px] inline-block" alt="Master card" />
                            </label>
                        </div>
                        ...
                        <div class="relative">
                            ...
                            <label
                                class="flex flex-col justify-center items-center bg-white border-[#EDEDED] cursor-pointer focus:outline-none hover:bg-gray-50 peer-checked:ring-[#0D63F3] peer-checked:ring-2 peer-checked:border-transparent rounded-3xl border-2 p-7"
                                for="mewallet">
                                <img src="{{ asset('/assets/fronsite/images/mewallet.png') }}"
                                    class="max-h-[50px] inline-block" alt="Master card" />
